...
p = alphas*nodes(elem(294,:),:);

fprintf('\t\tPart (A)\nP = (%.8e, %.8e)\n',p)

% Part (B)
% Interpolate the value of the point P=(40.0,15.4) in the mesh defined 
% by the file meshTwoHolesQuad.m when we assign the value on the nodes 
% equal to their global number (as in the practices).
